...
enum class PluginLanguageConfiguration(
    ...
    JAVA(
        ...
        TemplateContext(
            id = JAVA_TEMPLATE_CONTEXT_ID,
            presentableName = ResourceBundle.message("template.context.name.java")
        )
    ),
    KOTLIN(
        KotlinLanguage.INSTANCE,
        TemplateContext(
            id = KOTLIN_TEMPLATE_CONTEXT_ID,
            presentableName = ResourceBundle.message("template.context.name.kotlin")
        )
    );
